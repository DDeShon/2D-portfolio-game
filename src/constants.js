...
export const dialogueData = {
  pc: `This is my PC. I work mostly in JavaScript/TypeScript these days.
    I've made a couple of games in that language. I also like C# and Python. Anyway regardless of the language, I just like programming.
    Here is my <a href="" target="_blank">Github</a>!`,
  ...
  resume: `This is my desk and on it is my resume.</a>`,
